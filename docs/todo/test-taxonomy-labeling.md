...
- [ ] `internal/workspaceid/validate_test.go`
- [ ] `internal/core/excerpt/excerpt_test.go`
- [ ] `internal/agenthooks/normalize_test.go`
- [ ] `internal/core/identity/semantic_types_test.go`
- [ ] `internal/core/tree/semantic_types_test.go`
