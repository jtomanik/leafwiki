...
var _ = ginkgo.Describe("ginkgo and gomega quality regressions", ginkgo.Label("unit"), func() {
	...
	ginkgo.It("returns false for nil errors", func() {})                                     // want "Ginkgo node name \"returns false for nil errors\" describes a boolean return value; document the observable behavior instead"
