...
func TestIssueCarriesSemanticPathsAndPageIDs(t *testing.T) {
	t.Parallel()
...
func TestWorkspaceMarkdownLinkResolverReturnsMetadataPageIDs(t *testing.T) {
	rootDir := t.TempDir()
...
func TestValidateWorkspaceMarkdownFilesLinkIssueCarriesResolvedMetadataPageID(t *testing.T) {
	rootDir := t.TempDir()
